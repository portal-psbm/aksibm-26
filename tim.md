...
## 📋 Struktur Tim & Penanggung Jawab per Kriteria

| Peran | Tugas Utama | Kriteria LAM Teknik 2025 | Anggota |
|-------|-------------|--------------------------|--------|
| **Ketua Tim** | Koordinasi keseluruhan, validasi akhir dokumen, komunikasi dengan jurusan/PNJ | **K8 (Lulusan)** – sebagai penentu utama | AW |
| **Sekretaris** | Administrasi dokumen, pengarsipan digital, kontrol timeline, sinkronisasi LKPS–LED | Semua kriteria | SH |
...
- **LKPS dan LED harus sinkron** — tidak boleh ada klaim di LED yang tidak didukung data di LKPS
